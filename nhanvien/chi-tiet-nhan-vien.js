...
function NhanVienCT(props) {
    ...
    useEffect(()=>{
      async function getDatFromAPI(){
        var response = await fetch('http://127.0.0.1:8000/api/nhanvien/chi-tiet/7');
          ...
          <div className="col-lg-4">
            <div className="card mb-4" style={{ width: 600, background: 'smoke', left: 400 }}>
              <div className="card-body text-center">
                ...
                <Link to="/trang-chu" className="btn btn-primary" onClick={() => window.location.href = "/trang-chu"}>Quay lại</Link>
